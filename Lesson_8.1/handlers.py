...
async def mes_start(message: types.Message):
    ...
    if not new_game:
        await message.answer(f'Привет, {name}! Сыграем в игру под названием: "конфеты".\n'
                             f'Выбери количество конфет: '
                             f'напиши /set и через пробел количество конфет,\n'
                             f'а потом нажми /new_game\n\n/rules - Правила игры в конфеты\n')
...
@dp.message_handler(commands=['rules'])  # добавлено правило игры
